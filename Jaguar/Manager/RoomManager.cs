...
namespace Jaguar.Manager
{
    public static class RoomManager
    {
        ...
        /// <returns></returns>
        public static Room? FindRoom(long id) => GetRooms<Room>().FirstOrDefault(r => r.UniqueId == id);
        /// <summary>
        /// return room with user
        /// </summary>
        /// <param name="user"></param>
        /// <returns></returns>
        public static Room FindRoom(User user) => GetRooms<Room>().FirstOrDefault(r => r.Users.Any(u => u != null && u.UniqueId == user.UniqueId))!;
